            ...
            <div className="flex flex-col text-center items-center justify-center">
                ...
                <div className="mt-10">
                    ...
                    <div className="flex flex-col gap-4 max-w-lg md:max-w-6xl mb-8">
                        <p className="w-[80%] lg:w-[100%] mx-auto">I am a Software Developer and Rally Co-Driver based in London. I am a team-oriented individual with a multi-cultural background,
                            having lived in 8 different countries over the past 25 years.</p>
                        <p className="w-[80%] lg:w-[100%] mx-auto">Upon to my return to the UK in 2016, I have worked predominantly in the automotive industry for companies including Mercedes-Benz and McLaren Automotive.
                        ...
                        <p className="w-[80%] lg:w-[100%] mx-auto">
                        ...
                        <p className="w-[80%] lg:w-[100%] mx-auto"> In Regards to Software, I graduated from the Xander Academy in May 2023, and have since decided to start a Degree at the University of West London studying a BSc in Computer Science.
